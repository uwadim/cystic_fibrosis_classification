...
class SkipGCN(Module):
    ...
    def __init__(self, config, num_node_features):
        ...
        self.conv2 = GCNConv(hidden_channels + 1, hidden_channels + 1, cached=True, normalize=False)
        # skip connection: hidden_channels + hidden_channels + residuals
        self.conv3 = GCNConv(2 * hidden_channels + 1, 2 * hidden_channels + 1, cached=True, normalize=False)
